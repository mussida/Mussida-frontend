...
>(({ title, description, positiveButton, negativeButton }, ref) => {
	...
	const [isLoadingPositiveAction, setIsLoadingPositiveAction] =
		useState(false);
	...
	return (
		...
		>
			...
			>
				...
				<Text
					variant="bodyLarge"
					style={{ paddingBottom: 32, textAlign: "left" }}
				>
					{description}{" "}
				</Text>
				<View
				...
				>
					<Button
						...
						disabled={
							negativeButton.disabled || isLoadingPositiveAction
						}
						mode={"text"}
					>
						{negativeButton.text}
					...
					<Button
						...
						disabled={
							positiveButton.disabled || isLoadingPositiveAction
						}
						mode={"contained"}
					>
						{positiveButton.text}
